    ...
    <body>
        <div class="w3-card-4">
            ...
            <footer class="w3-container w3-teal">
                <h5>Generated by A100705::EngWeb2023 in ${d}</h5>
            </footer>
        </div>
    </body>
...
exports.composerPage = function( compositor, d ){
    ...
    pagHTML +=     `</ul></div>
            <footer class="w3-container w3-teal">
                <address>Gerado por A100705::EngWeb2024 em ${d}</address>
            </footer>
        </div>
    </body>
    </html>
...
exports.errorPage = function(errorMessage, d){
    ...
    <body>
        <div class="w3-card-4">
            ...
            <footer class="w3-container w3-teal">
                <address>Gerado por A100705::EngWeb2024 em ${d} - [<a href="javascript:history.back()">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
